...
class ConnectionDialog(QDialog):
    def __init__(self, startItem, endItem, mainWindow, parent=None):
        ...
        langGraphStartAsset = next(
                (asset for asset in self.mainWindow.langGraph.assets
        ...
        for assoc in langGraphStartAsset.associations:
            ...
            for (leftAsset, rightAsset) in assetPairs:
                if not self.mainWindow.model.association_exists_between_assets(
                        assoc.name,
                        leftAsset,
                        rightAsset):
    ...
    def OkButtonClicked(self):
        ...
        if selectedItem:
            ...
            self.mainWindow.model.add_association(association)
        self.accept()
