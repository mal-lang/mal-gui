...
from PySide6.QtCore import QPoint, QRectF, QSize, QSizeF, Qt
...
class NodeGraphicsObject(QGraphicsObject): #This is inherting from QGraphicsItem
    ...
    def itemChange(self, change: QGraphicsItem.GraphicsItemChange, value: typing.Any) -> typing.Any:
        ...
        value : any
        """
        # if change == self.ItemPositionChange and self.scene(): #Akash
